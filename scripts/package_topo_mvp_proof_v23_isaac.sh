...
copy_if_exists "${RUN_DIR}" "${PROOF_DIR}/runs/v23_isaac"
copy_if_exists "${ROOT_DIR}/configs/isaac_scenes_v23.yaml" "${PROOF_DIR}/configs/isaac_scenes_v23.yaml"
...
for f in \
  ...
  scripts/topo_eval_suite_v23_isaac.sh \
  ...
  scripts/package_topo_mvp_proof_v23_isaac.sh
 do
