...
copy_if_exists "${RUN_DIR}" "${PROOF_DIR}/runs/v22_isaac"
copy_if_exists "${ROOT_DIR}/configs/isaac_scenes_v22.yaml" "${PROOF_DIR}/configs/isaac_scenes_v22.yaml"
...
for f in \
  ...
  scripts/topo_eval_suite_v22_isaac.sh \
  ...
  scripts/package_topo_mvp_proof_v22_isaac.sh
do
