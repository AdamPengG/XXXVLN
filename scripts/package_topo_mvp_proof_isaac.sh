...
copy_if_exists "${RUN_DIR}" "${PROOF_DIR}/runs/v21_isaac"
copy_if_exists "${ROOT_DIR}/configs/isaac_scenes_v21.yaml" "${PROOF_DIR}/configs/isaac_scenes_v21.yaml"
